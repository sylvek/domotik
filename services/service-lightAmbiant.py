...
# morning
schedule.every().day.at("6:00").do(publish, m='#1C3EA0')
schedule.every().day.at("6:10").do(publish, m='#2550D0')
schedule.every().day.at("6:20").do(publish, m='#2856DE')
schedule.every().day.at("6:30").do(publish, m='#2B5DF1')
schedule.every().day.at("6:40").do(publish, m='#2C60F8')
schedule.every().day.at("7:00").do(publish, m='#F8F800')
schedule.every().day.at("7:10").do(publish, m='#F87C00')
schedule.every().day.at("7:15").do(publish, m='#F800BA')
schedule.every().day.at("7:20").do(publish, m='#000000')
...
schedule.every().day.at("23:00").do(publish, m='#000000')
