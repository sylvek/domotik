...
import net.sylvek.domotik.app.util.SystemUiHider;
...
public class FullscreenActivity extends Activity {
    ...
    public class PushReceiver extends BroadcastReceiver {
        ...
        {
            String topic[] = i.getStringExtra(MQTTservice.TOPIC).split("/");
            String message = i.getStringExtra(MQTTservice.MESSAGE);
            textView.setText(topic[1] + " " + message + ((topic[2].equals("temp")) ? "°c" : "W"));
        }
    }
    ...
    class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (b != null) {
                ...
                Toast.makeText(FullscreenActivity.this, (status) ? "success" : "fail", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName arg0, IBinder binder)
        {
            ...
            data.putCharSequence(MQTTservice.INTENTNAME, "net.sylvek.domotik.PushReceived");
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        intentFilter.addAction("net.sylvek.domotik.PushReceived");
